...
class PortugueseBRVirtualKeyboardLayout: VirtualKeyboardLayout() {
    ...
    protected override val keyboardInputs: Map<Char, ByteArray> by lazy {
        mapOf(
            ...
            'ç' to byteArrayOf(0x00, KeyboardKey.ROW_3_KEY_09.byte),
            ...
            'ˋ' to byteArrayOf(0x02, KeyboardKey.ROW_2_KEY_10.byte),
            ...
            'Ç' to byteArrayOf(0x02, KeyboardKey.ROW_3_KEY_09.byte),
            'ˆ' to byteArrayOf(0x02, KeyboardKey.ROW_3_KEY_10.byte),
            ...
            '?' to byteArrayOf(0x40, KeyboardKey.ROW_2_KEY_01.byte),
            '€' to byteArrayOf(0x40, KeyboardKey.ROW_2_KEY_02.byte),
            'ª' to byteArrayOf(0x40, KeyboardKey.ROW_2_KEY_11.byte),

            'º' to byteArrayOf(0x40, KeyboardKey.ROW_3_KEY_11.byte),
